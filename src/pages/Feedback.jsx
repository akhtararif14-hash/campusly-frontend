  ...
  if (submitted) return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
      <div className="text-center max-w-sm w-full">
        ...
        <p className="text-zinc-400 text-sm mb-6">Your feedback has been sent to the admin. We appreciate you helping make Campusly better!</p>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 pb-24">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-zinc-500 text-xs">Help us improve Campusly</p>
          </div>
        </div>
